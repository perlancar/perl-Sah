...
C<TYPE_NAME> is a string, C<CLAUSE_SET> is a hash of clauses. The old form:

 [TYPE_NAME, CLAUSE_SET, EXTRAS]

(where EXTRAS is a hash) is deprecated but still supported, although EXTRAS is
...
schemas to be put in the schema itself in the extras part, but for simplicity
