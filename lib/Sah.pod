...
Specify operator for (multiple) clause values. Possible values for this
...
Another example:
 ...
 ["str", {"!in": ["root", "admin"],
          ...
          "in.err_msg.id_ID": "Maaf, nama user dilarang digunakan"
 }]
...
The extras part of a schema (the third element) contains various stuffs. It is a
DefHash that can contain these keys:
